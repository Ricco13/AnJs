...
cl = LineClient(authToken='Ev3VuzPvB2c7TEIDrXra.gIHgalwJsMTFisMR+xM0wG.RYQcXjh7TSoDX92TQZU7QxE0MqgQzRWeiRrTZkeQdZM=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='Ev7LotKlR4852ANO8DLd.z/87WpbvdOsAOUP+LMoQdq.H0Oc79FgUHEOBfewQ/xP94xxN5eLODHtlNZdTcZDAGA=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='Ev9zlPnmIxfjeUXxnKW7.c3QkYcvlmbtibfbllPtUTW.s9hqEUlPpvtq1T5BDm+8+WUDHsiZ4FxuAd1sd3Q26cI=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='Ev4jTWXWjpDP3bICzFn1.MDYVhzMV4DyUakir+e4l8q.YJ6rF34LHrlFNvQj+owrXpJWUIHCYDy30UEhkbtj2cU=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

sw = LineClient(authToken='Ev9M0JFIech6f96PvZ35.L/0T2wlsjlklKMxZqoBpjq.JaG9lH7F76rL+8XgzRarGgtml7D3kT5HNp5n4NqzTRg=')
...
owner = ["u1a284600b5a34a6b5f2129abfd79b45a"]
admin = ["u1a284600b5a34a6b5f2129abfd79b45a"]
staff = ["u1a284600b5a34a6b5f2129abfd79b45a"]
...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"Yang Sider Gue Doain Mancung.....Ke Dalem!!!",
    "Respontag":"Gak Usah Tag Lah...Gue Lagi Kencan Ama Cewek Gue",
    "welcome":"Welcome To Gerombolan Pekok...Silahkan Liat Liat Note...Biar Kenal Ama Orang Orang Pekoknya",
    "comment":"Like like & like by zz7Bot",
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator zz7Bot") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, "┃🇮🇩┃ ┃zz7Bot┃ Family Grup Info\n\n┃🇮🇩┃ Nama Group : {}".format(G.name)+ "\n┃🇮🇩┃ ID Group : {}".format(G.id)+ "\n┃🇮🇩┃ Pembuat : {}".format(G.creator.displayName)+ "\n┃🇮🇩┃ Waktu Dibuat : {}".format(str(timeCreated))+ "\n┃🇮🇩┃ Jumlah Member : {}".format(str(len(G.members)))+ "\n┃🇮🇩┃ Jumlah Pending : {}".format(gPending)+ "\n┃🇮🇩┃ Group Qr : {}".format(gQr)+ "\n┃🇮🇩┃ Group Ticket : {}".format(gTicket))
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"┃🇮🇩┃ ┃zz7Bot┃ Family bot\n\n"+ma+"\nTotal「%s」Family Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "┃🇮🇩┃ ┃zz7Bot┃ Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"┃🇮🇩┃ ┃zz7Bot┃ Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"┃🇮🇩┃ ┃zz7Bot┃ Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
